...
```markdown
![APT Installed](s[creenshots/01-apt-installed.png](https://github.com/PankajSwami-Cyber/PankajSwami-Cyber/blob/main/Labs/linux-package-management-lab/screenshots/2%20APT%20Installed.png))
